        ...
        public override void UpdateLights(EffectFrame frame)
        {
            ...
            switch (Global.Configuration.IdleType)
            {
                ...
                case IdleEffects.ColorBreathing:
                    ...
                    Color breathe_bg_color = Global.Configuration.IdleSecondaryColor;
                    ...
                    layer.Fill(Color.FromArgb((byte)(sine * 255), Global.Configuration.IdlePrimaryColor));
                ...
                case IdleEffects.StarFall:
                    ...
                    layer.Fill(Global.Configuration.IdleSecondaryColor);

                    Devices.DeviceKeys[] stars_keys = stars.Keys.ToArray();

                    foreach (Devices.DeviceKeys star in stars_keys)
                    {
                        layer.Set(star, Utils.ColorUtils.MultiplyColorByScalar(Global.Configuration.IdlePrimaryColor, stars[star]));
                ...
                case IdleEffects.RainFall:
                    ...
                    ColorSpectrum drop_spec = new ColorSpectrum(Global.Configuration.IdlePrimaryColor, Color.FromArgb(0, Global.Configuration.IdlePrimaryColor));
                ...
                case IdleEffects.Matrix:
                    ...
                    if (nextstarset < currenttime)
                    {
                        Color darker_primary = Utils.ColorUtils.MultiplyColorByScalar(Global.Configuration.IdlePrimaryColor, 0.50);
                        ...
                        for (int x = 0; x < Global.Configuration.IdleAmount; x++)
                        {
                            ...
                            AnimationTrack matrix_line =
                                new AnimationTrack("Matrix Line (Head) " + random_id, 0.0f).SetFrame(
                                    0.0f * 1.0f / (0.05f * Global.Configuration.IdleSpeed), new AnimationLine(width_start, -3, width_start, 0, Global.Configuration.IdlePrimaryColor, 3)).SetFrame(
                                    0.5f * 1.0f / (0.05f * Global.Configuration.IdleSpeed), new AnimationLine(width_start, Effects.canvas_height, width_start, Effects.canvas_height + 3, Global.Configuration.IdlePrimaryColor, 3)).SetShift(
